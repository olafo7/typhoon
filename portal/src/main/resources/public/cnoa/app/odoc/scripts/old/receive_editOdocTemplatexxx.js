...
var CNOA_odoc_receive_apply_edit, CNOA_odoc_receive_apply_editClass;
CNOA_odoc_receive_apply_editClass = CNOA.Class.create();
CNOA_odoc_receive_apply_editClass.prototype = {
	init : function(){
		var _this = this;
	...
	submit : function(){
		...
		if (_this.form.getForm().isValid()) {
			_this.form.getForm().submit({
				url: _this.baseUrl + "&task=createodoc",
	...
	*/
	...
	sendNext : function(){
		var _this =this;
		CNOA_odoc_receive_apply_selectFlow = new CNOA_odoc_receive_apply_selectFlowClass(_this.id);
	},
...
CNOA_odoc_receive_apply_selectFlowClass = CNOA.Class.create();
CNOA_odoc_receive_apply_selectFlowClass.prototype = {
	init: function(id){
		var _this = this;
...
Ext.onReady(function() {
	if(!Ext.isIE){
		...
		CNOA_odoc_receive_apply_edit = new CNOA_odoc_receive_apply_editClass();
		CNOA_odoc_receive_apply_edit.mainPanel.doLayout();
	}
});