...
class wfEngineUserSubmit extends wfEngineInterface implements wfEngineInterface
{

    protected $code = "userSubmit";
    ...
    public function runWithoutBindingStep( )
    {
        ...
        $bindingCheckId = $CNOA_DB->db_getfield( "checkId", $this->table_user_binding, "WHERE id=2" );
