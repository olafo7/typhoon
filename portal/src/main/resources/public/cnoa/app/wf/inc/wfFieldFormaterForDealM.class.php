...
class wfFieldFormaterForDealM extends wfCommon
{
    ...
    public function __construct( $_obfuscate_F4AbnVRh, $_obfuscate_0Ul8BBkt, $_obfuscate_FygnrXwW3bt6 = TRUE, $_obfuscate_TlvKhtsoOQ?? = 0 )
    {
        global $CNOA_DB;
    ...
    public function crteateFormHtml( )
    {
        ...
        else
        {
            ...
            if ( $this->uFlowId != 0 )
            {
                $_obfuscate_4puJ00P0cS = $this->api_getWfFieldData( $this->flowId, $this->uFlowId, TRUE );
            }
        }
        ...
        foreach ( $this->flowFields as $_obfuscate_iXc? => $_obfuscate_WgE? )
        {
            ...
            if ( $_obfuscate_WgE?['dvalue'] == "undefined" )
            {
                $_obfuscate_WgE?['dvalue'] = $this->flowFields[$_obfuscate_iXc?]['dvalue'] = "";
            }
        ...
        if ( !empty( $this->flowInfo['bindfunction'] ) )
        {
            ...
            {
                $_obfuscate_qXF5WAWqYSI? = ( integer )getpar( $_GET, "salaryApproveId" );
                $_obfuscate_Y5Z1gD8kyymc9JqLpGOZdXw? = "<p><a style='display:none' otype='salaryApproveId' value='".$_obfuscate_qXF5WAWqYSI?."'></a></p>";
                $this->flowInfo['formHtml'] .= $_obfuscate_Y5Z1gD8kyymc9JqLpGOZdXw?;
            }
            else if ( $this->flowInfo['bindfunction'] == "userReadlySubmit" || $this->flowInfo['bindfunction'] == "userSubmit" )
            {
                $_obfuscate_0eI4mradFg?? = getpar( $_GET, "userCid" );
                $_obfuscate_T2rlpIaPV3w? = "<p><a style='display:none' otype='userCid' value='".$_obfuscate_0eI4mradFg??."'></a></p>";
                $this->flowInfo['formHtml'] .= $_obfuscate_T2rlpIaPV3w?;
            }
    ...
    public function getDetailedTable( )
    {
        ...
        unset( $_obfuscate_mPAjEGLn );
        unset( $_obfuscate_8jhldA9Y9A?? );
        $_obfuscate_ZY3bzECSsQ?? = getpar( $_GET, "tableId", getpar( $_POST, "tableId", "" ) );
        foreach ( $this->flowFields as $_obfuscate_iXc? => $_obfuscate_WgE? )
        {
            if ( !( $_obfuscate_WgE?['otype'] == "detailtable" ) && $_obfuscate_WgE?['id'] != $_obfuscate_ZY3bzECSsQ?? )
            {
                $_obfuscate_6mlyHg?? = $this->stepFields[$_obfuscate_WgE?['id']];
                if ( empty( $_obfuscate_6mlyHg?? ) )
                {
                ...
                if ( $_obfuscate_6mlyHg??['show'] == 1 )
                {
                    $_obfuscate_TiWG8KgKCGQJJXY1Mnsp = $this->formatFormItem( $_obfuscate_WgE?, $this->fieldRule, $_obfuscate_4puJ00P0cS[$_obfuscate_WgE?['id']] );
                }
                else if ( $_obfuscate_WgE?['otype'] == "calculate" )
                {
                    $_obfuscate_TiWG8KgKCGQJJXY1Mnsp = $this->formatFormItem( $_obfuscate_WgE?, $this->fieldRule, $_obfuscate_4puJ00P0cS[$_obfuscate_WgE?['id']] );
                ...
                {
                    $_obfuscate_TiWG8KgKCGQJJXY1Mnsp = "";
                }
            }
        }
        if ( !empty( $this->flowInfo['bindfunction'] ) )
        {
            ...
            {
                $_obfuscate_qXF5WAWqYSI? = ( integer )getpar( $_GET, "salaryApproveId" );
                $_obfuscate_Y5Z1gD8kyymc9JqLpGOZdXw? = "<p><a class='engineSign' style='display:none' otype='salaryApproveId' value='".$_obfuscate_qXF5WAWqYSI?."'></a></p>";
                $_obfuscate_TiWG8KgKCGQJJXY1Mnsp .= $_obfuscate_Y5Z1gD8kyymc9JqLpGOZdXw?;
            }
            else if ( $this->flowInfo['bindfunction'] == "userReadlySubmit" || $this->flowInfo['bindfunction'] == "userSubmit" )
            {
                $_obfuscate_0eI4mradFg?? = getpar( $_GET, "userCid" );
                $_obfuscate_T2rlpIaPV3w? = "<p><a class='engineSign' style='display:none' otype='userCid' value='".$_obfuscate_0eI4mradFg??."'></a></p>";
                $_obfuscate_TiWG8KgKCGQJJXY1Mnsp .= $_obfuscate_T2rlpIaPV3w?;
            }
            $_obfuscate_TiWG8KgKCGQJJXY1Mnsp = "<p><a class=\"engineSign\" style=\"display:none\" otype=\"bindfunc\" value=\"".$this->flowInfo['bindfunction']."\"></a></p>".$_obfuscate_TiWG8KgKCGQJJXY1Mnsp;
        }
        return $_obfuscate_TiWG8KgKCGQJJXY1Mnsp;
    }
    ...
    public function formatFormItem( $element, $rule, $value = "" )
    {
        ...
        if ( in_array( $element['otype'], array( "textfield", "textarea", "select", "radio", "checkbox", "calculate", "macro", "choice", "detailtable", "signature", "jumpKongjian", "datasource", "attach" ) ) )
        {
    ...
    private function _format_signature( $_obfuscate_60GquoKMPw??, $_obfuscate_6mlyHg??, $_obfuscate_VgKtFeg? = "" )
    {
        ...
        if ( $_obfuscate_9VrqILQ == "Phone" || $_obfuscate_9VrqILQ == "Tablet" )
        {
            ...
            {
                $_obfuscate_lEGQqw?? = "{$_obfuscate_LQ8UKg??}<img fieldid=\"{$_obfuscate_60GquoKMPw??['id']}\"  text=\"{{$_obfuscate_60GquoKMPw??['name']}}\" data=\"{$_obfuscate_60GquoKMPw??['style']}\" src=\"{$_obfuscate_VgKtFeg?['url']}\" style=\"{$_obfuscate_0sRnHy4?}\" /></span>";
                $_obfuscate_6RYLWQ?? = "url:".$_obfuscate_VgKtFeg?['url'].";left:{$_obfuscate_VgKtFeg?['left']};top:{$_obfuscate_VgKtFeg?['top']}";
            }
            else
            {
                $_obfuscate_lEGQqw?? .= "<button fieldid=\"".$_obfuscate_60GquoKMPw??['id']."\"  text=\"{{$_obfuscate_60GquoKMPw??['name']}}\" data=\"{$_obfuscate_60GquoKMPw??['style']}\" style=\"{$_obfuscate_60GquoKMPw??['style']}\" >{$_obfuscate_60GquoKMPw??['name']}</button>";
            }
        ...
        if ( $_obfuscate_6mlyHg??['write'] == 1 )
        {
            ...
            else if ( $_obfuscate_p5ZWxr4?['type'] == "electron" )
            {
                ...
                if ( $_obfuscate_p5ZWxr4?['kind'] == "all" || $_obfuscate_p5ZWxr4?['kind'] == "seal" )
                {
                    ...
                    {
                        $_obfuscate_LQ8UKg?? .= "<input type=\"hidden\" oname=\"".$_obfuscate_60GquoKMPw??['name']."\" sealstoredata=\"true\" value=\"".$_obfuscate_VgKtFeg?['seal']."\" id=\"seal_wf_signature_style=\"".$_obfuscate_60GquoKMPw??['style']."\" ".$_obfuscate_60GquoKMPw??['name']."\" />";
                    }
                }
    ...
    private function _format_macro( $_obfuscate_60GquoKMPw??, $_obfuscate_6mlyHg??, $_obfuscate_VgKtFeg? = "" )
    {
        ...
        $_obfuscate_LQ8UKg?? = "<input type=\"text\" id=\"wf_field_".$_obfuscate_60GquoKMPw??['id']."\" qtip=\"".$_obfuscate_60GquoKMPw??['name']."<br>?????¡ä?????1???<span class='cnoa_color_red'>".$_obfuscate_VgKtFeg?."</span>\"field=\"".$_obfuscate_60GquoKMPw??['id']."\"otype=\"".$_obfuscate_60GquoKMPw??['otype']."\" oname=\"".$_obfuscate_60GquoKMPw??['name']."\" class=\"wf_field wf_field_read\" value=\"".$_obfuscate_VgKtFeg?."\" ".( "style='".$_obfuscate_0sRnHy4?."' " )."readonly=\"readonly\" tabindex=\"".$_obfuscate_60GquoKMPw??['order']."\" />";
        return $_obfuscate_LQ8UKg??;
    }
    ...
    private function _format_choice( $_obfuscate_60GquoKMPw??, $_obfuscate_6mlyHg??, $_obfuscate_VgKtFeg? = "" )
    {
        ...
        $_obfuscate_AlW8F6SaSV8O = "<input type=\"text\" qtip=\"".$_obfuscate_60GquoKMPw??['name']."\" otype=\"".$_obfuscate_60GquoKMPw??['otype']."\" class=\"wf_field".$_obfuscate_F43xrelD_9A?."\" ".$_obfuscate_vZOcQA??.$_obfuscate_TervNcSylPE?.$_obfuscate_0sRnHy4?."id=\"wf_field_".$_obfuscate_60GquoKMPw??['id']."\" field=\"".$_obfuscate_60GquoKMPw??['id']."\" name=\"wf_field_".$_obfuscate_60GquoKMPw??['id']."\" tabindex=\"".$_obfuscate_60GquoKMPw??['order']."\" oname=\"".$_obfuscate_60GquoKMPw??['name']."\" ";
        ...
        case "dept_sel" :
            ...
            $_obfuscate_AlW8F6SaSV8O = "<input type=\"text\" qtip=\"".$_obfuscate_60GquoKMPw??['name']."\" otype=\"".$_obfuscate_60GquoKMPw??['otype']."\" class=\"wf_field".$_obfuscate_F43xrelD_9A?."\" ".$_obfuscate_vZOcQA??.$_obfuscate_TervNcSylPE?.$_obfuscate_0sRnHy4?."to=\"wf_field_".$_obfuscate_60GquoKMPw??['id']."\" value=\"".$_obfuscate_VcY7imjf."\" oname=\"".$_obfuscate_60GquoKMPw??['name']."\" ";
            if ( $_obfuscate_6mlyHg??['write'] == 1 )
            {
        ...
        case "depts_sel" :
            ...
            $_obfuscate_AlW8F6SaSV8O = "<textarea qtip=\"".$_obfuscate_60GquoKMPw??['name']."\" otype=\"".$_obfuscate_60GquoKMPw??['otype']."\" class=\"wf_field".$_obfuscate_F43xrelD_9A?."\" ".$_obfuscate_vZOcQA??.$_obfuscate_TervNcSylPE?.$_obfuscate_0sRnHy4?."tabindex=\"".$_obfuscate_60GquoKMPw??['order']."\" to=\"wf_field_".$_obfuscate_60GquoKMPw??['id']."\" oname=\"".$_obfuscate_60GquoKMPw??['name']."\" ";
            if ( $_obfuscate_6mlyHg??['write'] == 1 )
            {
        ...
        case "station_sel" :
            ...
            $_obfuscate_AlW8F6SaSV8O = "<input type=\"text\" qtip=\"".$_obfuscate_60GquoKMPw??['name']."\" otype=\"".$_obfuscate_60GquoKMPw??['otype']."\" class=\"wf_field".$_obfuscate_F43xrelD_9A?."\" ".$_obfuscate_vZOcQA??.$_obfuscate_TervNcSylPE?.$_obfuscate_0sRnHy4?."to=\"wf_field_".$_obfuscate_60GquoKMPw??['id']."\" value=\"".$_obfuscate_VcY7imjf."\" tabindex=\"".$_obfuscate_60GquoKMPw??['order']."\" oname=\"".$_obfuscate_60GquoKMPw??['name']."\" ";
            if ( $_obfuscate_6mlyHg??['write'] == 1 )
            {
        ...
        case "job_sel" :
            ...
            $_obfuscate_AlW8F6SaSV8O = "<input type=\"text\" qtip=\"".$_obfuscate_60GquoKMPw??['name']."\" otype=\"".$_obfuscate_60GquoKMPw??['otype']."\" class=\"wf_field".$_obfuscate_F43xrelD_9A?."\" ".$_obfuscate_vZOcQA??.$_obfuscate_TervNcSylPE?.$_obfuscate_0sRnHy4?."tabindex=\"".$_obfuscate_60GquoKMPw??['order']."\" to=\"wf_field_".$_obfuscate_60GquoKMPw??['id']."\" value=\"".$_obfuscate_VcY7imjf."\" oname=\"".$_obfuscate_60GquoKMPw??['name']."\" ";
            if ( $_obfuscate_6mlyHg??['write'] == 1 )
            {
        ...
        case "user_sel" :
            ...
            $_obfuscate_AlW8F6SaSV8O = "<div class=\"choice sendee ".$_obfuscate_vZOcQA??."\" id=\"wf_field_".$_obfuscate_60GquoKMPw??['id']."\" data-name=\"wf_field_".$_obfuscate_60GquoKMPw??['id']."\" ".$_obfuscate_TervNcSylPE?." data-datatype=\"user_sel\" data-checktype=\"false\" data-toggle=\"modal\" ".( $_obfuscate_6mlyHg??['write'] == 1 ? "data-target=\"#userDataModal\"" : "" ).">";
            $_obfuscate_AlW8F6SaSV8O .= "<span class=\"name\" data-uid=\"".$_obfuscate_VgKtFeg?."\">".$_obfuscate_VcY7imjf."</span>";
            $_obfuscate_AlW8F6SaSV8O .= "</div>";
            $_obfuscate_LQ8UKg?? = $_obfuscate_AlW8F6SaSV8O."<input type=\"hidden\" value=\"".$_obfuscate_VgKtFeg?."\" name=\"wf_field_".$_obfuscate_60GquoKMPw??['id']."\"/>";
            break;
        case "users_sel" :
            if ( !empty( $_obfuscate_VgKtFeg? ) )
            {
        ...
        case "kehuEgressRecord" :
            $_obfuscate_AlW8F6SaSV8O = "<div id='ID_RECORD'".( "qtip='[".$_obfuscate_60GquoKMPw??['name']."]' " ).( "otype='".$_obfuscate_60GquoKMPw??['otype']."' " ).( "class='wf_field".$_obfuscate_F43xrelD_9A?."' " ).$_obfuscate_vZOcQA??.$_obfuscate_TervNcSylPE?.$_obfuscate_0sRnHy4?.( "tabindex='".$_obfuscate_60GquoKMPw??['order']."' " ).( "to='wf_field_".$_obfuscate_60GquoKMPw??['id']."' " ).( "oname='".$_obfuscate_60GquoKMPw??['name']."' " );
            if ( $_obfuscate_6mlyHg??['write'] == 1 )
            {
    ...
    private function _format_datasource( $_obfuscate_60GquoKMPw??, $_obfuscate_6mlyHg??, $_obfuscate_VgKtFeg? = "" )
    {
        if ( $_obfuscate_6mlyHg??['write'] )
        {
            ...
            $_obfuscate_LQ8UKg?? = "<input type=\"button\" id=\"wf_field_".$_obfuscate_60GquoKMPw??['id']."\" qtip=\"".$_obfuscate_60GquoKMPw??['name']."\" otype=\"".$_obfuscate_60GquoKMPw??['otype']."\" fieldId=\"".$_obfuscate_60GquoKMPw??['id']."\" datasource=\"".$_obfuscate_p5ZWxr4?['datasource']."\" maps='".json_encode( $_obfuscate_EU3Hg?? )."' tabindex=\"".$_obfuscate_60GquoKMPw??['order']."\" value=\"".$_obfuscate_60GquoKMPw??['name']."\" />";
    ...
    public function _format_detailtable( $_obfuscate_60GquoKMPw??, $_obfuscate_6mlyHg??, $_obfuscate_VgKtFeg? )
    {
        global $CNOA_DB;
        $_obfuscate_p5ZWxr4? = $this->__getOdata( $_obfuscate_60GquoKMPw??['odata'] );
        ...
        $_obfuscate_TCA9GkaGBg?? = $_obfuscate_p5ZWxr4?['tdattrs'];
        if ( 0 < count( $_obfuscate_p5ZWxr4?['items'] ) )
        {
            $_obfuscate_YpUjY5I? = "<tr>";
            foreach ( $_obfuscate_p5ZWxr4?['items'] as $_obfuscate_5w?? => $_obfuscate_6A?? )
            {
                $_obfuscate_YpUjY5I? .= "<td style=\"".$_obfuscate_TCA9GkaGBg??[$_obfuscate_5w??]['style']."\">";
                $_obfuscate_YpUjY5I? .= "<strong><span>".$_obfuscate_6A??['name']."</span></strong>";
                $_obfuscate_YpUjY5I? .= "</td>";
            }
            $_obfuscate_YpUjY5I? .= "</tr>";
        }
        $_obfuscate_ = "<table style=\"border-collapse:collapse; border:none; margin-bottom:10px;\" bordercolor=\"#000000\" bgcolor=\"#ffffff\" border=\"1\"><tbody>";
        $_obfuscate_ .= $_obfuscate_YpUjY5I?.$_obfuscate_LQ8UKg??;
        $_obfuscate_ .= "</tbody></table>";
...
class wfDetailTableFormaterForDeal extends wfCommon
{
 ...
 $_obfuscate_7w?? <= $this->odata['rownumber']; ++$_obfuscate_7w??, )
    ...
    {
        $this->tdNum = 0;
        $_obfuscate_k6U? = "<tr class=\"detail-line\" style=\"height:".$this->odata['height']."px;\" data-rownum=\"".$_obfuscate_PWqEdpnd."\" detail=\"".$this->tableEl['id']."\">";
        ...
        if ( $this->tableRule['write'] == 1 )
        {
            ...
            {
                $_obfuscate_QbLi3SeqTlw? = preg_match( "/^admarticles.*/", $_obfuscate_iaimBq6DVyXvuDch ) ? substr( $_obfuscate_iaimBq6DVyXvuDch, 0, -1 ) : "jxcGoods";
                if ( in_array( $_obfuscate_iaimBq6DVyXvuDch, array( "admarticlesd", "admarticlesb" ) ) )
                {
                    if ( $_obfuscate_PWqEdpnd == 1 )
                    {
                        ...
                        $_obfuscate_k6U? .= "<div class=\"fs1 wf_row_jia\" aria-hidden=\"true\" data-icon=\"P\" queryadd=\"true\" style=\"display:none;\"></div>";
                        $_obfuscate_k6U? .= "</td>";
                    }
                    else
                    {
                        $_obfuscate_k6U? .= "<td align=\"center\" valign=\"middle\" style=\"border:none;\" width=\"20\">";
                        $_obfuscate_k6U? .= "<div class=\"fs1 wf_row_jian\" aria-hidden=\"true\" data-icon=\"O\"></div>";
                        $_obfuscate_k6U? .= "</td>";
                    }
                ...
                else if ( in_array( $_obfuscate_iaimBq6DVyXvuDch, array( "admarticlesc", "jxcRuku", "jxcChuku" ) ) )
                {
                    if ( $_obfuscate_PWqEdpnd == 1 )
                    {
                        $_obfuscate_k6U? .= "<td align=\"center\" valign=\"middle\" style=\"border:none;\" width=\"20\">";
            ...
            else
            {
                ...
                if ( $_obfuscate_PWqEdpnd == 1 )
                {
                    $_obfuscate_k6U? .= "<div class=\"fs1 wf_row_jia\" aria-hidden=\"true\" data-icon=\"P\"></div>";
                }
                else
                {
                    $_obfuscate_k6U? .= "<div class=\"fs1 wf_row_jian\" aria-hidden=\"true\" data-icon=\"O\"></div>";
    ...
    private function _format_textfield( $_obfuscate_60GquoKMPw??, $_obfuscate_6mlyHg??, $_obfuscate_VgKtFeg? = "", $_obfuscate_zdFnXMEXKAQUUA?? = FALSE )
    {
        ...
        $_obfuscate_0sRnHy4? = "style=\"".$_obfuscate_60GquoKMPw??['style'].";".$_obfuscate_0sRnHy4?[0].";".$_obfuscate_0sRnHy4?[1].";text-align:center;\" ";
        ...
        if ( $_obfuscate_6mlyHg??['write'] == 1 )
        {
            $_obfuscate_LQ8UKg?? = "<input type=\"text\" ".$_obfuscate_vZOcQA??.$_obfuscate_0W8?.$_obfuscate_3gn_eQ??.$_obfuscate_XoQj4PaA.( $_obfuscate_p5ZWxr4?['dataType'] == "str" ? "" : "autoformat=\"".$this->autoFormatPHP[$_obfuscate_p5ZWxr4?['dataType']][$_obfuscate_p5ZWxr4?['dataFormat']]."\" " )."qtip=\"".$_obfuscate_60GquoKMPw??['name'].$_obfuscate_4Bjbo6tz."\"otype=\"".$_obfuscate_p5ZWxr4?['type']."\" oname=\"".$_obfuscate_60GquoKMPw??['name']."\" field=\"".$_obfuscate_gfGsQGKrGg??."\"class=\"wf_field".$_obfuscate_F43xrelD_9A?."\" value=\"".$_obfuscate_VgKtFeg?."\" isnum=\"".( $this->wfFFFD->__isNum( $_obfuscate_p5ZWxr4?['dataType'] ) ? "true" : "false" )."\" ".$this->__getBindFieldStr( $_obfuscate_p5ZWxr4?['bindField'] ).$this->__getBindMaxNumStr( $_obfuscate_gfGsQGKrGg??, $this->nowLine ).$_obfuscate_0sRnHy4?.$_obfuscate_TervNcSylPE?." />";
            return $_obfuscate_LQ8UKg??;
        }
        $_obfuscate_LQ8UKg?? = "<span style=\";display:inline-block;width: 120px;\">".$_obfuscate_VgKtFeg?."</span>";
        return $_obfuscate_LQ8UKg??;
    }
    ...
    private function _format_calculate( $_obfuscate_60GquoKMPw??, $_obfuscate_6mlyHg??, $_obfuscate_VgKtFeg? = "", $_obfuscate_zdFnXMEXKAQUUA?? = FALSE )
    {
        ...
        else
        {
            ...
            $_obfuscate_LQ8UKg?? = "<input ".$_obfuscate_XoQj4PaA." type=\"text\" id=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" name=\"wf_detailJ_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" qtip=\"".$_obfuscate_60GquoKMPw??['name']."\" field=\"".$_obfuscate_gfGsQGKrGg??."\"otype=\"".$_obfuscate_p5ZWxr4?['type']."\" oname=\"".$_obfuscate_60GquoKMPw??['name']."\" class=\"wf_field wf_field_read ".$_obfuscate_p5ZWxr4?['type']."\" ".$_obfuscate_0sRnHy4?.$this->__getBindFieldStr( $_obfuscate_p5ZWxr4?['bindField'] ).$this->__getBindMaxNumStr( $_obfuscate_gfGsQGKrGg??, $this->nowLine )."readonly=\"readonly\" value=\"".$_obfuscate_VgKtFeg?."\" gongshi=\"".$_obfuscate_sSwuE42EWQ??."\" roundtype=\"".$_obfuscate_p5ZWxr4?['dataFormat']."\" baoliu=\"".$_obfuscate_p5ZWxr4?['baoliu']."\"/>";
        }
    ...
    private function _format_macro( $_obfuscate_60GquoKMPw??, $_obfuscate_6mlyHg??, $_obfuscate_VgKtFeg? = "", $_obfuscate_zdFnXMEXKAQUUA?? = FALSE )
    {
        ...
        if ( $_obfuscate_6mlyHg??['write'] == 1 )
        {
            ...
            case "createrstation" :
                ...
                $_obfuscate_LQ8UKg?? .= "value=\"".$_obfuscate_97K3."\" ".$_obfuscate_TervNcSylPE?."/>";
            case "loginname" :
                $_obfuscate_LQ8UKg?? = "<input type=\"text\" value=\"".$CNOA_SESSION->get( "TRUENAME" )."\" class=\"wf_field".$_obfuscate_F43xrelD_9A?."\"  qtip=\"".$_obfuscate_60GquoKMPw??['name'].( "\" ".$_obfuscate_0sRnHy4?." {$_obfuscate_TervNcSylPE?} />" );
    ...
    private function _format_choice( $_obfuscate_60GquoKMPw??, $_obfuscate_6mlyHg??, $_obfuscate_VgKtFeg? = "", $_obfuscate_zdFnXMEXKAQUUA?? = FALSE )
    {
        ...
        {
        case "date_sel" :
            $_obfuscate_yFuhcmzFsw?? = "style=\"".$_obfuscate_60GquoKMPw??['style'].";".$_obfuscate_0sRnHy4?[0].";".$_obfuscate_0sRnHy4?[1].";";
            if ( $_obfuscate_6mlyHg??['edit'] == 1 )
            {
                $_obfuscate_yFuhcmzFsw?? .= "background-color: #eee;";
            }
            else
            {
                $_obfuscate_yFuhcmzFsw?? .= "background-color: #fff;";
            }
            $_obfuscate_yFuhcmzFsw?? .= "\" ";
            $_obfuscate_AlW8F6SaSV8O = "<input type=\"text\" ".$_obfuscate_yFuhcmzFsw??."qtip=\"".$_obfuscate_60GquoKMPw??['name']."\" otype=\"".$_obfuscate_60GquoKMPw??['otype']."\" class=\"wf_field".$_obfuscate_F43xrelD_9A?." WdatePicker\" data-readOnly=\"".( $_obfuscate_6mlyHg??['write'] == 1 ? "false" : "true" )."\" ".$_obfuscate_vZOcQA??.$this->__getBindFieldStr( $_obfuscate_p5ZWxr4?['bindField'] ).$this->__getBindMaxNumStr( $_obfuscate_gfGsQGKrGg??, $this->nowLine )."value=\"".$_obfuscate_VgKtFeg?."\" id=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" field=\"".$_obfuscate_gfGsQGKrGg??."\"name=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" oname=\"".$_obfuscate_60GquoKMPw??['name']."\" ";
            switch ( $_obfuscate_p5ZWxr4?['dataFormat'] )
            {
            case 100 :
                $_obfuscate_ead0WM? = "yyyy-MM-dd";
            ...
            $_obfuscate_LQ8UKg?? = $_obfuscate_AlW8F6SaSV8O."odata=\"date_sel\"dtfmt=\"".$_obfuscate_ead0WM?."\" readOnly>";
            break;
        case "time_sel" :
            $_obfuscate_sgMx59N70Q?? = "style=\"".$_obfuscate_60GquoKMPw??['style'].";".$_obfuscate_0sRnHy4?[0].";".$_obfuscate_0sRnHy4?[1].";";
            if ( $_obfuscate_6mlyHg??['write'] == 1 )
            {
                $_obfuscate_sgMx59N70Q?? .= "background-color: #fff;";
            }
            else
            {
                $_obfuscate_sgMx59N70Q?? .= "background-color: #eee;";
            }
            $_obfuscate_sgMx59N70Q?? .= "\" ";
            $_obfuscate_AlW8F6SaSV8O = "<input type=\"text\" ".$_obfuscate_sgMx59N70Q??."qtip=\"".$_obfuscate_60GquoKMPw??['name']."\" otype=\"".$_obfuscate_60GquoKMPw??['otype']."\" class=\"wf_field".$_obfuscate_F43xrelD_9A?." WdatePicker\" data-readOnly=\"".( $_obfuscate_6mlyHg??['write'] == 1 ? "false" : "true" )."\" ".$_obfuscate_vZOcQA??.$this->__getBindFieldStr( $_obfuscate_p5ZWxr4?['bindField'] ).$this->__getBindMaxNumStr( $_obfuscate_gfGsQGKrGg??, $this->nowLine )."value=\"".$_obfuscate_VgKtFeg?."\" id=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" field=\"".$_obfuscate_gfGsQGKrGg??."\"name=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" oname=\"".$_obfuscate_60GquoKMPw??['name']."\" ";
            switch ( $_obfuscate_p5ZWxr4?['dataFormat'] )
            {
            case 100 :
            ...
            $_obfuscate_LQ8UKg?? = $_obfuscate_AlW8F6SaSV8O.$_obfuscate_VgKtFeg?."odata=\"time_sel\"dtfmt=\"".intval( $_obfuscate_p5ZWxr4?['dataFormat'] )."\" readonly>";
            break;
        case "dept_sel" :
            $_obfuscate_0sRnHy4? = "style=\";width:".$_obfuscate_ncdC0pM?."px;height:".$_obfuscate_3FCLQL2p."px;overflow:auto;\" ";
            if ( !empty( $_obfuscate_VgKtFeg? ) )
            {
                $_obfuscate_VcY7imjf = app::loadapp( "main", "struct" )->api_getNameById( $_obfuscate_VgKtFeg? );
            }
            $_obfuscate_AlW8F6SaSV8O = "<div qtip=\"".$_obfuscate_60GquoKMPw??['name']."\" otype=\"choice\" class=\"deptChoice wf_field".$_obfuscate_F43xrelD_9A?." ".( $_obfuscate_vZOcQA?? ? "must" : "" )."\" id=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" data-name=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" data-readonly=\"".( $_obfuscate_6mlyHg??['write'] == 1 ? "" : "true" )."\" data-checktype=\"false\" data-datatype=\"dept_sel\" ".( $_obfuscate_6mlyHg??['write'] == 1 ? "data-toggle=\"modal\" data-target=\"#stationDataModal\" " : "\"\" " ).$_obfuscate_vZOcQA??.$_obfuscate_0sRnHy4?."to=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" oname=\"".$_obfuscate_60GquoKMPw??['name']."\" ><span class=\"name\" data-did=\"".$_obfuscate_VgKtFeg?."\">".$_obfuscate_VcY7imjf."</span></div>";
            $_obfuscate_LQ8UKg?? = $_obfuscate_AlW8F6SaSV8O."<input type=\"hidden\" value=\"".$_obfuscate_VgKtFeg?."\" name=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\"/>";
            break;
        case "depts_sel" :
            $_obfuscate_0sRnHy4? = "style=\";width:".$_obfuscate_ncdC0pM?."px;height:".$_obfuscate_3FCLQL2p."px;overflow:auto;\" ";
            if ( !empty( $_obfuscate_VgKtFeg? ) )
            ...
            $_obfuscate_AlW8F6SaSV8O = "<div qtip=\"".$_obfuscate_60GquoKMPw??['name']."\" otype=\"choice\" class=\"deptChoice wf_field".$_obfuscate_F43xrelD_9A?." ".( $_obfuscate_vZOcQA?? ? "must" : "" )."\" id=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" data-name=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" data-readonly=\"".( $_obfuscate_6mlyHg??['write'] == 1 ? "" : "true" )."\" data-checktype=\"true\" data-datatype=\"dept_sel\" ".( $_obfuscate_6mlyHg??['write'] == 1 ? "data-toggle=\"modal\" data-target=\"#stationDataModal\" " : "\"\" " ).$_obfuscate_vZOcQA??.$_obfuscate_0sRnHy4?."to=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" oname=\"".$_obfuscate_60GquoKMPw??['name']."\" ><span class=\"name\" data-did=\"".$_obfuscate_VgKtFeg?."\">".$_obfuscate_VcY7imjf."</span></div>";
            $_obfuscate_LQ8UKg?? = $_obfuscate_AlW8F6SaSV8O."<input type=\"hidden\" value=\"".$_obfuscate_VgKtFeg?."\" name=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\"/>";
            break;
        case "station_sel" :
            $_obfuscate_0sRnHy4? = "style=\";width:".$_obfuscate_ncdC0pM?."px;height:".$_obfuscate_3FCLQL2p."px;overflow:auto;\" ";
            $_obfuscate_AlW8F6SaSV8O = "<div qtip=\"".$_obfuscate_60GquoKMPw??['name']."\" otype=\"choice\" class=\"stationChice wf_field".$_obfuscate_F43xrelD_9A?." ".( $_obfuscate_vZOcQA?? ? "must" : "" )."\" id=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" data-name=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" data-readonly=\"".( $_obfuscate_6mlyHg??['write'] == 1 ? "" : "true" )."\" data-checktype=\"false\" data-datatype=\"station_sel\" ".( $_obfuscate_6mlyHg??['write'] == 1 ? "data-toggle=\"modal\" data-target=\"#stationDataModal\" " : "\"\" " ).$_obfuscate_vZOcQA??.$_obfuscate_0sRnHy4?."to=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" field=\"".$_obfuscate_gfGsQGKrGg??."\"oname=\"".$_obfuscate_60GquoKMPw??['name']."\" >";
            "<span class=\"name\" data-sid=\"".$_obfuscate_VgKtFeg?."\">".$_obfuscate_VcY7imjf."</span></div>";
            $_obfuscate_LQ8UKg?? = $_obfuscate_AlW8F6SaSV8O."<input type=\"hidden\" value=\"".$_obfuscate_VgKtFeg?."\" name=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\"/>";
            break;
        case "stations_sel" :
            $_obfuscate_0sRnHy4? = "style=\";width:".$_obfuscate_ncdC0pM?."px;height:".$_obfuscate_3FCLQL2p."px;overflow:auto;\" ";
            $_obfuscate_AlW8F6SaSV8O = "<div qtip=\"".$_obfuscate_60GquoKMPw??['name']."\" otype=\"choice\" class=\"stationChice wf_field".$_obfuscate_F43xrelD_9A?." ".( $_obfuscate_vZOcQA?? ? "must" : "" )."\" id=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" data-name=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" data-readonly=\"".( $_obfuscate_6mlyHg??['write'] == 1 ? "" : "true" )."\" data-checktype=\"true\" data-datatype=\"station_sel\" ".( $_obfuscate_6mlyHg??['write'] == 1 ? "data-toggle=\"modal\" data-target=\"#stationDataModal\" " : "\"\" " ).$_obfuscate_vZOcQA??.$_obfuscate_0sRnHy4?."to=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" field=\"".$_obfuscate_gfGsQGKrGg??."\"oname=\"".$_obfuscate_60GquoKMPw??['name']."\" >";
            "<span class=\"name\" data-sid=\"".$_obfuscate_VgKtFeg?."\">".$_obfuscate_VcY7imjf."</span></div>";
            $_obfuscate_LQ8UKg?? = $_obfuscate_AlW8F6SaSV8O."<input type=\"hidden\" value=\"".$_obfuscate_VgKtFeg?."\" name=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\"/>";
            break;
        case "job_sel" :
            $_obfuscate_0sRnHy4? = "style=\";width:".$_obfuscate_ncdC0pM?."px;height:".$_obfuscate_3FCLQL2p."px;overflow:auto;\" ";
            $_obfuscate_AlW8F6SaSV8O = "<div qtip=\"".$_obfuscate_60GquoKMPw??['name']."\" otype=\"choice\" class=\"jobChoice wf_field".$_obfuscate_F43xrelD_9A?." ".( $_obfuscate_vZOcQA?? ? "must" : "" )."\" id=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" data-name=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" data-readonly=\"".( $_obfuscate_6mlyHg??['write'] == 1 ? "" : "true" )."\" data-checktype=\"false\" data-datatype=\"job_sel\" ".( $_obfuscate_6mlyHg??['write'] == 1 ? "data-toggle=\"modal\" data-target=\"#stationDataModal\" " : "\"\" " ).$_obfuscate_vZOcQA??.$_obfuscate_0sRnHy4?."to=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" field=\"".$_obfuscate_gfGsQGKrGg??."\"oname=\"".$_obfuscate_60GquoKMPw??['name']."\" >";
            "<span class=\"name\" data-jid=\"".$_obfuscate_VgKtFeg?."\">".$_obfuscate_VcY7imjf."</span></div>";
            $_obfuscate_LQ8UKg?? = $_obfuscate_AlW8F6SaSV8O."<input type=\"hidden\" value=\"".$_obfuscate_VgKtFeg?."\" name=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\"/>";
            break;
        case "jobs_sel" :
            $_obfuscate_0sRnHy4? = "style=\";width:".$_obfuscate_ncdC0pM?."px;height:".$_obfuscate_3FCLQL2p."px;overflow:auto;\" ";
            $_obfuscate_AlW8F6SaSV8O = "<div qtip=\"".$_obfuscate_60GquoKMPw??['name']."\" otype=\"choice\" class=\"jobChoice wf_field".$_obfuscate_F43xrelD_9A?." ".( $_obfuscate_vZOcQA?? ? "must" : "" )."\" id=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" data-name=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" data-readonly=\"".( $_obfuscate_6mlyHg??['write'] == 1 ? "" : "true" )."\" data-checktype=\"true\" data-datatype=\"job_sel\" ".( $_obfuscate_6mlyHg??['write'] == 1 ? "data-toggle=\"modal\" data-target=\"#stationDataModal\" " : "\"\" " ).$_obfuscate_vZOcQA??.$_obfuscate_0sRnHy4?."to=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" field=\"".$_obfuscate_gfGsQGKrGg??."\"oname=\"".$_obfuscate_60GquoKMPw??['name']."\" >";
            "<span class=\"name\" data-jid=\"".$_obfuscate_VgKtFeg?."\">".$_obfuscate_VcY7imjf."</span></div>";
            $_obfuscate_LQ8UKg?? = $_obfuscate_AlW8F6SaSV8O."<input type=\"hidden\" value=\"".$_obfuscate_VgKtFeg?."\" name=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\"/>";
            break;
        case "user_sel" :
            ...
            $_obfuscate_AlW8F6SaSV8O = "<div qtip=\"".$_obfuscate_60GquoKMPw??['name']."\" otype=\"choice\" class=\"sendee wf_field".$_obfuscate_F43xrelD_9A?." ".( $_obfuscate_vZOcQA?? ? "must" : "" )." \" id=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" data-name=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" data-readonly=\"".( $_obfuscate_6mlyHg??['write'] == 1 ? "" : "true" )."\" data-datatype=\"user_sel\" data-checktype=\"false\" ".$_obfuscate_0sRnHy4?.$_obfuscate_vZOcQA??.( $_obfuscate_6mlyHg??['write'] == 1 ? "data-toggle=\"modal\" data-target=\"#userDataModal\" " : "\" \"" ).$this->__getBindFieldStr( $_obfuscate_p5ZWxr4?['bindField'] ).$this->__getBindMaxNumStr( $_obfuscate_gfGsQGKrGg??, $this->nowLine )."to=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" field=\"".$_obfuscate_gfGsQGKrGg??."\" oname=\"".$_obfuscate_60GquoKMPw??['name']."\" ><span class=\"name\" data-uid=\"".$_obfuscate_VgKtFeg?."\">".$_obfuscate_VcY7imjf."</span></div>";
            $_obfuscate_LQ8UKg?? = $_obfuscate_AlW8F6SaSV8O."<input type=\"hidden\" value=\"".$_obfuscate_VgKtFeg?."\" class=\"user_sel\" name=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" />";
            break;
        case "users_sel" :
            $_obfuscate_0sRnHy4? = "style=\";width:".$_obfuscate_ncdC0pM?."px;height:".$_obfuscate_3FCLQL2p."px;overflow:auto;\" ";
            if ( !empty( $_obfuscate_VgKtFeg? ) )
            ...
            $_obfuscate_AlW8F6SaSV8O = "<div qtip=\"".$_obfuscate_60GquoKMPw??['name']."\" otype=\"choice\" class=\"sendee wf_field".$_obfuscate_F43xrelD_9A?." ".( $_obfuscate_vZOcQA?? ? "must" : "" )." \" id=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" data-name=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" data-readonly=\"".( $_obfuscate_6mlyHg??['write'] == 1 ? "" : "true" )."\" data-datatype=\"user_sel\" data-checktype=\"true\" ".$_obfuscate_0sRnHy4?.$_obfuscate_vZOcQA??.( $_obfuscate_6mlyHg??['write'] == 1 ? "data-toggle=\"modal\" data-target=\"#userDataModal\" " : "\" \"" ).$this->__getBindFieldStr( $_obfuscate_p5ZWxr4?['bindField'] ).$this->__getBindMaxNumStr( $_obfuscate_gfGsQGKrGg??, $this->nowLine )."to=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" field=\"".$_obfuscate_gfGsQGKrGg??."\" oname=\"".$_obfuscate_60GquoKMPw??['name']."\" ><span class=\"name\" data-uid=\"".$_obfuscate_VgKtFeg?."\">".$_obfuscate_VcY7imjf."</span></div>";
            $_obfuscate_LQ8UKg?? = $_obfuscate_AlW8F6SaSV8O."<input type=\"hidden\" value=\"".$_obfuscate_VgKtFeg?."\" class=\"user_sel\" name=\"wf_detail_".$this->nowLine."_".$_obfuscate_gfGsQGKrGg??."\" />";
        }
        return $_obfuscate_LQ8UKg??;
    }
