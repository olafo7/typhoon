...
DESKTOPAPP_CLASS.prototype = {
	init : function(portalsID){
		...
		var me = this,
			desktopId = "CNOA_MAIN_DESKTOP_USER_FOLLOWUP";
	...
	chartPanel: function(){
        ...
        var chart = new Ext.Panel({
        	border: false,
	        html: "<div style='width: 100%; height: 490px;' id='CNOA_ID_FOLLOW_UP"+rand_ID+"'>",
				...
				items:[
					...
					s_time,
					{
						...
						handler: function(){
							...
							$("#CNOA_ID_FOLLOW_UP"+rand_ID).html();
							Ext.Ajax.request({
								url: _this.baseUrl + "&task=followUp",
								...
								success: function(h) {
									...
									funnel.render("CNOA_ID_FOLLOW_UP"+rand_ID);
								}
							})
						}
					}
