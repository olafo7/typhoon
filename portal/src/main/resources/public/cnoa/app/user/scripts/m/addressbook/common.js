	...
	addressbook_list: function(json,isEmpty){
		...
		if(json.success && json.data.length > 0){
			$.each(json.data, function(index,array){
				...
				str += "<span class=\"grouping\">"+array['group']+"</span>";
...
$(function(){
	...
	//加载我的通讯录
	addressbookList('m.php?app=user&func=addressbook&action=default&task=loadPage&from=list&task=getCommonAddressBook');
