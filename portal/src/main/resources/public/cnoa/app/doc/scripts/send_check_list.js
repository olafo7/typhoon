//定义全局变量：
var CNOA_doc_send_check_listClass, CNOA_doc_send_check_list;
...
*
*/
CNOA_doc_send_check_listClass = CNOA.Class.create();
CNOA_doc_send_check_listClass.prototype = {
	init : function(){
		var _this = this;
		
		this.baseUrl = "index.php?app=doc&func=send&action=check";
				...
				items: [
					{
						...
						allowDepress: false,
						pressed: true,
						toggleGroup: "doc_send_check_list",
						handler:function(){
...
Ext.onReady(function() {
	CNOA_doc_send_check_list = new CNOA_doc_send_check_listClass();
	Ext.getCmp(CNOA.doc.send.check_list.parentID).add(CNOA_doc_send_check_list.mainPanel);
	Ext.getCmp(CNOA.doc.send.check_list.parentID).doLayout();
});