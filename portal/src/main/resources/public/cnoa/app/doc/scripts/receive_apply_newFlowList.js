var CNOA_doc_receive_apply_newFlowListClass, CNOA_doc_receive_apply_newFlowList;

/**
* 主面板-列表
*
*/
CNOA_doc_receive_apply_newFlowListClass = CNOA.Class.create();
CNOA_doc_receive_apply_newFlowListClass.prototype = {
	init : function(){
		var _this = this;
	...
	makeOperate : function(value, cellmeta, record, rowIndex, columnIndex, color_store){
		...
		var h  = "<div style='margin-top:2px;'><a href='javascript:void(0);' onclick='CNOA_doc_receive_apply_newFlowList.newFlow("+value+");'><img src='"+src+"page_addedit.png' style='margin:0 2px 4px 0' align='absmiddle' />"+lang('new')+"</a>";
			h += "</div>";
		return h;
	},
...
Ext.onReady(function() {
	CNOA_doc_receive_apply_newFlowList = new CNOA_doc_receive_apply_newFlowListClass();
	Ext.getCmp(CNOA.doc.receive.apply_newFlowList.parentID).add(CNOA_doc_receive_apply_newFlowList.mainPanel);
	Ext.getCmp(CNOA.doc.receive.apply_newFlowList.parentID).doLayout();
});