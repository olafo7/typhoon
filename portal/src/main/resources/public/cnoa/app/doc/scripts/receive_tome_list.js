//定义全局变量：
var CNOA_doc_receive_tome_listClass, CNOA_doc_receive_tome_list;
...
*
*/
CNOA_doc_receive_tome_listClass = CNOA.Class.create();
CNOA_doc_receive_tome_listClass.prototype = {
	init : function(){
		var _this = this;
		
		this.baseUrl = "index.php?app=doc&func=receive&action=tome";
			...
			tbar : new Ext.Toolbar({
				items: [
					...
					},
					{
						...
						allowDepress: false,
						pressed: true,
						toggleGroup: "doc_receive_tome_list",
						handler:function(){
...
Ext.onReady(function() {
	CNOA_doc_receive_tome_list = new CNOA_doc_receive_tome_listClass();
	Ext.getCmp(CNOA.doc.receive.tome_list.parentID).add(CNOA_doc_receive_tome_list.mainPanel);
	Ext.getCmp(CNOA.doc.receive.tome_list.parentID).doLayout();
});