...
DESKTOPAPP_CLASS.prototype = {
	init : function(portalsID){
		...
		var me = this,
			desktopId = "CNOA_MAIN_DESKTOP_EDBACKGROUND";
	...
	chartPanel: function(){
		...
		var chart = new Ext.Panel({
			border: false,
	        html: "<div style='width: 100%; height: 490px;' id='CNOA_ED_BG_CHART"+rand_ID+"'>",
	        listeners: {
	        	afterrender: function(){
	        		Ext.Ajax.request({
	        			url: _this.baseUrl + "&task=edBackground",
	        			success : function(response){
	        				...
	        				mychart.render("CNOA_ED_BG_CHART"+rand_ID);
	        			}
	        		})
	        	}
	        }
